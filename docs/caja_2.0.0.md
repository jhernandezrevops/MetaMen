  ...
  * @tu-usuario
  ...
  TAREA-02.8.1:
    Nombre: "Crear estructura de carpetas base"
    Acción: "Crear todos los directorios del árbol"
    Responsable: Antigravity
    Comando: |
      ...
      mkdir -p "src/app/(dashboard)/dashboard/tools/{library,gym,meditation,journal,kegel,facial,hyp